...
module.exports = (pool) =>{
    ...
    return {
         ...
         * @description If successful, returns the user_id of the newly created user. Otherwise, it returns an error
         */
        async Register(req, res) {
            try {
                ...
                const user_id = await userModel.createUser(userName, hash, pool)
